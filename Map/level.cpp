    ...
    if (map->FirstChildElement("objectgroup") != NULL)
    {
        ...
        while (objectGroupElement)
        {
            ...
            while(objectElement)
            {
                ...
                sf::Sprite sprite;
                sprite.setTexture(tilesetImage);
                sprite.setTextureRect(sf::Rect<int>(0,0,0,0));//здесь какая-то лажа
                ...
                //ИЗМЕНЕНИЕ
                //object.sprite.setTextureRect(sf::IntRect(x,y,width,height));
                // "Переменные" объекта
...
void Level::objInit(b2World&world, std::vector<Object>&block){
